...
const experts = [
  {
    name: "MUNIR HUSSAIN",
    role: "Founder",
    img: "/assets/Experts/munir.jpg",
  },
  {
    name: "AITEZAZ ZAREEN",
    role: "Chief Executive Officer (CEO)",
    img: "/assets/Experts/aitezaz.jpg",
  },
  {
    name: "ALI ZAREEN",
    role: "Co-Founder",
  ...
  },
  {
    ...
    img: "/assets/Experts/shafi.jpg",
  },
  {
    name: "SAQIB SEMAAB",
    role: "Marketing Head",
    img: "/assets/Experts/saqib.jpg",
  },
  {
    name: "ZIA KHAN",
    role: "Marketing Executive",
    img: "/assets/Experts/zia.jpg",
  },
];
  ...
  return (
    <main className="bg-gray-50 text-gray-800">
      ...
      <section className="py-16 bg-[#0a1f44] text-white text-center">
        ...
        <Link
          to="/contact"
          className="px-6 py-3 bg-yellow-500 text-[#0a1f44] font-semibold rounded-lg hover:bg-yellow-400"
        >
          Contact Us
        </Link>
      </section>
