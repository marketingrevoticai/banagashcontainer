...
// // // import hero4 from "/assets/hero/hero2.1.webp";
// // // import hero5 from "/assets/hero/office.webp";
...
// import hero1 from "/assets/hero/hero5.png";
// import hero2 from "/assets/hero/hero4.webp";
// import hero3 from "/assets/hero/hero3.webp";
// import hero4 from "/assets/hero/hero2.1.webp";
// import hero5 from "/assets/hero/Office.webp";
// import hero6 from "/assets/hero/bangash-container-hero.webp";
...
//       {/* Content bg-[#facc15] */}
//       <div className="relative z-20 max-w-3xl px-6 md:px-16">
//         <p className="bg-transperent border-white[1px] text-[#0a1f44] text-xs md:text-sm font-semibold inline-block px-4 py-1 rounded">
//           {slide.subtitle}
//         </p>
//         <h1 className="text-3xl md:text-5xl font-extrabold leading-tight mt-4 mb-6">
//           {slide.title}
...
//           <button
//             onClick={handlePrimaryClick}
//             className="bg-white hover:bg-yellow-400 text-[#0a1f44] font-semibold px-6 py-3 rounded-md transition"
//           >
//             {slide.btnPrimary}
//           </button>
//           <button
...
import hero1 from "/assets/hero/hero5.webp";
import hero2 from "/assets/hero/hero4.webp";
import hero3 from "/assets/hero/hero3.webp";
import hero4 from "/assets/hero/hero2.1.webp";
import hero5 from "/assets/hero/Office.webp";
...
// FIXED: Use same key for navigation -> primaryLink & secondaryLink ONLY
const slides = [
  {
    image: hero4,
    subtitle: "YOUR TRUSTED CONTAINER SOLUTION PROVIDER",
...
export default function HeroSection() {
  ...
  const handlePrimaryClick = () => {
    if (slide.primaryLink) navigate(slide.primaryLink);
  };

  const handleSecondaryClick = () => {
    if (slide.secondaryLink) navigate(slide.secondaryLink);
  };
  ...
  return (
    <section className="relative w-full h-[85vh] flex items-center justify-start text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-3xl px-6 md:px-16">
        ...
        {/* Subtitle with FIXED border */}
        <p className="border border-white text-white text-[10px] md:text-sm font-semibold inline-block px-4 py-1 rounded">
          {slide.subtitle}
        </p>
        ...
        <div className="flex gap-4">
          <button
            onClick={handlePrimaryClick}
            className="bg-white hover:bg-gray-300 text-[#0a1f44] font-semibold px-6 py-3 rounded-md transition-all"
          >
            {slide.btnPrimary}
          </button>
          ...
          <button
            onClick={handleSecondaryClick}
            className="border border-white text-white hover:bg-white hover:text-[#0a1f44] font-semibold px-6 py-3 rounded-md transition-all"
          >
            {slide.btnSecondary}
          </button>
        </div>
      ...
      <div className="absolute right-6 top-1/2 -translate-y-1/2 flex flex-col gap-3 z-30">
        {slides.map((_, index) => (
          <button
            key={index}
            onClick={() => setCurrent(index)}
            className={`w-3 transition-all rounded-full ${index === current
              ? "h-6 bg-white rounded-md"
              : "h-3 bg-gray-300"
              }`}
          ></button>
        ))}
