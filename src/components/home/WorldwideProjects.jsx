...
// import offerImg from "/assets/Product1/containerhallint2.jpg";
// Project data with route links
const projects = [
  {
    img: "/assets/WhyChooseUs/containerhome.jpg",
  ...
  {
    img: "/assets/WhyChooseUs/cafe.jpg",
  ...
  {
    img: "/assets/SecurityCabin/sec7.jpg",
    title: "Security Cabins",
    link: "services/security-cabins",
  },
  {
    img: "/assets/Product7/off13.jpg",
...
const WorldwideProjects = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: "url('/bg-blueprint.jpg')", // optional public background
