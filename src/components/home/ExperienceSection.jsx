  ...
  return (
    <section className="relative bg-[#0a1f44] text-white overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/assets/factory-bg.jpg')",
        }}
      ></div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="mt-10 bg-white text-[#0a1f44] rounded-2xl shadow-xl p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-3">
                <img
                  src="/assets/Industry/IND1.jpg"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
                <img
                  src="/assets/Industry/IND2.jpg"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
                <img
                  src="/assets/Industry/IND3.jpg"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-3">
                <img
                  src="/assets/Industry/IND4.jpg"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
                <img
                  src="/assets/Industry/IND5.jpg"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
                <img
                  src="/assets/Industry/IND6.jpg"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
              </div>
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-xl">
          <img
            src="/assets/WhyChooseUs/bchoffice.jpg"
            alt="Factory"
