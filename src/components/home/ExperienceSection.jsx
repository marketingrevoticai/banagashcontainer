  ...
  return (
    <section className="relative bg-[#0a1f44] text-white overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/assets/factory-bg.webp')",
        }}
      ></div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="mt-10 bg-white text-[#0a1f44] rounded-2xl shadow-xl p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-3">
                <img
                  src="/assets/Industry/IND1.webp"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
                <img
                  src="/assets/Industry/IND2.webp"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
                <img
                  src="/assets/Industry/IND3.webp"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-3">
                <img
                  src="/assets/Industry/IND4.webp"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
                <img
                  src="/assets/Industry/IND5.webp"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
                <img
                  src="/assets/Industry/IND6.webp"
                  alt=""
                  className="rounded-md object-cover h-20 w-full"
                />
              </div>
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-xl">
          <img
            src="/assets/WhyChooseUs/bchoffice.webp"
            alt="Factory"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50">
          <div className="relative bg-black rounded-lg w-[90%] md:w-[70%] lg:w-[60%] aspect-video">
            ...
            width="640"
            height="480"
            src="https://www.youtube.com/embed/834AH9UmPgs"
