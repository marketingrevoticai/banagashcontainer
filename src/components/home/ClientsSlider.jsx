...
import client1 from "/assets/Clients/MTCC.png";
import client2 from "/assets/Clients/nlc.png";
import client3 from "/assets/Clients/ptcl.png";
import client4 from "/assets/Clients/Sky.png";
import client5 from "/assets/Clients/UN.png";
import client6 from "/assets/Clients/Maersk.png";
            ...
            <SwiperSlide key={index}>
              <div className="flex justify-center items-center">
                <img
                  src={client.img}
                  alt={client.name}
                  className="h-80 md:h-80 object-contain grayscale hover:grayscale-0 transition duration-300"
                />
              </div>
            </SwiperSlide>
          ))}
