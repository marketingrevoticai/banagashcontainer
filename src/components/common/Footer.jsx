    ...
    <footer className="bg-[#0a1f44] text-gray-300 py-10 px-6">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 border-b border-gray-600 pb-8">
        ...
        <div>
          ...
          {/* <ul className="space-y-2 text-sm">
            <li><Link to="/product1" className="hover:text-blue-400">Prefabricated Homes</Link></li>
            <li><Link to="/product2" className="hover:text-blue-400">Prefabricated Office</Link></li>
            <li><Link to="/product3" className="hover:text-blue-400">Container Caravan</Link></li>
            <li><Link to="/product4" className="hover:text-blue-400">Container Homes</Link></li>
            <li><Link to="/product5" className="hover:text-blue-400">Container Offices</Link></li>
            <li><Link to="/product6" className="hover:text-blue-400">Security Cabins</Link></li>
          </ul> */}
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/services/prefabricated-homes" className="hover:text-blue-400">
                Prefabricated Homes
              </Link>
            </li>

            <li>
              <Link to="/services/fabricated-office" className="hover:text-blue-400">
                Prefabricated Office
              </Link>
            </li>

            <li>
              <Link to="/services/container-caravan" className="hover:text-blue-400">
                Container Caravan
              </Link>
            </li>

            <li>
              <Link to="/services/container-homes" className="hover:text-blue-400">
                Container Homes
              </Link>
            </li>

            <li>
              <Link to="/services/container-offices" className="hover:text-blue-400">
                Container Offices
              </Link>
            </li>

            <li>
              <Link to="/services/security-cabins" className="hover:text-blue-400">
                Security Cabins
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/our-experts" className="hover:text-blue-400">Our Experts</Link></li>
        ...
        <div>
          ...
          <div className="space-y-2 text-sm">
            <p className="flex items-center space-x-2">
              <Phone size={16} />{" "}
              <a href="tel:+923335061973" className="hover:text-blue-400">
                +92 333 5061973
              </a>
            </p>
            <p className="flex items-center space-x-2">
