...
// //         style={{
// //           backgroundImage:
// //             "url('/assets/offer.jpg')", // update this image path
// //         }}
// //       >
...
// // import interiorImg from "/assets/offer.jpg";
// // import ecoImg from "/assets/offer.jpg";
// // import modernImg from "/assets/offer.jpg";
// // import durableImg from "/assets/offer.jpg";
// // import transportImg from "/assets/offer.jpg";
// // import smartImg from "/assets/offer.jpg";
...
// //         style={{
// //           backgroundImage: "url('/assets/offer.jpg')",
// //         }}
// //       >
// //         <div className="absolute inset-0 bg-black bg-opacity-50"></div>
// //         <div className="relative z-10 text-center text-white px-6">
    ...
    <main className="bg-gray-50 text-gray-800">
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="p-6 text-center">
                  ...
                  <div className="mt-4">
                    <span className="inline-block text-sm font-medium text-[#0a1f44] group-hover:text-yellow-500 transition-all">
                      View More →
                    </span>
                  </div>
                </div>
      ...
      <section className="py-20 px-6 bg-white text-center">
        ...
        <Link
          ...
          hover:bg-yellow-500 hover:text-[#0a1f44] transition-all"
        >
          View Product
        </Link>
      </section>
