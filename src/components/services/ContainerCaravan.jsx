...
// //         style={{
// //           backgroundImage:
// //             "url('/assets/offer.webp')", // update this image path
// //         }}
// //       >
...
// // import interiorImg from "/assets/offer.webp";
// // import ecoImg from "/assets/offer.webp";
// // import modernImg from "/assets/offer.webp";
// // import durableImg from "/assets/offer.webp";
// // import transportImg from "/assets/offer.webp";
// // import smartImg from "/assets/offer.webp";
...
// //         style={{
// //           backgroundImage: "url('/assets/offer.webp')",
// //         }}
// //       >
// //         <div className="absolute inset-0 bg-black bg-opacity-50"></div>
// //         <div className="relative z-10 text-center text-white px-6">
  ...
  return (
    <main className="bg-gray-50 text-gray-800">
      ...
      <section className="py-20 px-6 md:px-16 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
            Our container caravans are designed for those who need flexible,
            stylish, and sustainable living or working spaces. Ideal for
            construction sites, tourism, mobile offices, and personal use
            these units combine practicality with modern design.
          </p>
        </div>
      </section>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="p-6 text-center">
                  ...
                  <div className="mt-4">
                    <span className="inline-block text-sm font-medium text-[#0a1f44] group-hover:text-blue-700 transition-all">
                      View More →
                    </span>
                  </div>
                </div>
      ...
      <section className="py-20 px-6 bg-white text-center">
        ...
        <Link
          to="/product1"
          className="inline-block bg-[#0a1f44] text-white font-semibold px-8 py-3 rounded-lg
          hover:bg-white hover:text-[#0a1f44] transition-all"
        >
          View Product
        </Link>
      </section>
