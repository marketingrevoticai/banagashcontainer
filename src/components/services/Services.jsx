  ...
  const services = [
    {
      ...
      img: "/assets/PrefabHome/prehome3.jpg",
    ...
    },
    {
      ...
      img: "/assets/Services/prehome3.jpg",
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    to={service.link}
                    className="inline-block px-5 py-2 rounded-lg bg-[#0a1f44] text-white hover:bg-yellow-500 hover:text-[#0a1f44] transition-all"
                  >
                    View Details →
                  </Link>
                </div>
