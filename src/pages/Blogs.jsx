...
import offerImage from "/assets/offer.webp"; // Correct image path
  ...
  return (
    <section className="bg-[#f9fafb]">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(0, 0, 0, 0.9), rgba(10,31,68,0.7)), url('/assets/offer.webp')",
        }}
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-4 text-gray-200 max-w-2xl mx-auto text-sm md:text-base">
            ...
            <span className="text-white font-semibold"> Bangash Containers </span>
          ...
          {blogs.map((blog) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-[#0a1f44] mt-3 group-hover:text-blue-700 transition-colors">
                  {blog.title}
                </h3>
                ...
                <Link
                  to={`/blogs/${blog.id}`}
                  className="mt-5 inline-block text-[#0a1f44] font-semibold hover:text-blue-700 transition-colors text-sm"
                >
                  Read More →
                </Link>
              </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <form className="flex flex-col md:flex-row justify-center gap-4 max-w-md mx-auto">
            <input
              ...
              required
              className="px-4 py-2 rounded-lg w-full text-black outline-none focus:ring-2 focus:ring-blue-700 text-sm"
            />
            <button
              type="submit"
              className="bg-white text-[#0a1f44] font-semibold px-6 py-2 rounded-lg hover:bg-gray-100 transition-all text-sm"
            >
              Subscribe
            </button>
          </form>
